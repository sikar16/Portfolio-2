...
import { useGetAllserviceQuery, useDeleteServiceMutation } from '../../../service/serviceApi';
    ...
    const columns = useMemo<MRT_ColumnDef<Service>[]>(
        () => [
            ...
            },
            {
                ...
                header: 'Image',
                size: 80,
                Cell: ({ cell }) => <img src={cell.getValue()} alt={cell.row.original.name} style={{ width: '50px', height: '50px' }} />,
            },
            {
                id: 'action',
                header: 'Action',
    ...
    return (
        <>
            <div className="flex justify-between my-4 items-center">
                <p className="ms-4 text-2xl font-semibold text-gray-800">Services</p>
                <div>
                    <button
