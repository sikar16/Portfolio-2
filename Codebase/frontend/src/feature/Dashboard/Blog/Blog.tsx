...
import { useGetAllblogQuery } from '../../../service/blogApi';
...
const Blog = () => {
    ...
    const columns = useMemo<MRT_ColumnDef<BlogEntry>[]>(
        () => [
            ...
            {
                accessorKey: 'image', // Ensure this matches your API response
                header: 'Image',
                size: 100,
                Cell: ({ cell }) => (
    ...
    if (isError) {
        return <div>Error fetching blog entries.</div>; // Error handling
    }
