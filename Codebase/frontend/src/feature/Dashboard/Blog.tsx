...
import { blogData } from '../../demo/makedata';
    ...
    return (
        <>
            <div className="flex justify-between my-4 items-center">
                <p className="ms-4 text-2xl font-semibold text-gray-800">Blog Entries</p>
                <div className="">
                    <button className="bg-[#F57920] text-white px-5 gap-1 py-2 rounded-lg flex items-center text-center align-middle" onClick={handleClickOpen}>
                        <span>Add Blog Entry</span>
                    </button>
                </div>
            </div>
            <MaterialReactTable table={table} />
            <Dialog open={open} onClose={handleClickClose}>
                <DialogTitle className="text-lg font-semibold text-gray-700">Add Blog Entry</DialogTitle>
                ...
                <DialogActions className="p-4">
                    ...
                    <Button onClick={handleClickClose} color="primary">Add Entry</Button>
                </DialogActions>
            </Dialog>
        </>
    );
