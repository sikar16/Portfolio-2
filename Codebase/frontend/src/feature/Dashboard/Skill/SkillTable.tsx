...
const SkillTable = () => {
    ...
    const { isError, isLoading, data } = useGetAllskillQuery();
    ...
    const table = useMaterialReactTable({
        columns,
        data: isLoading ? [] : data || [], // Use optional chaining to prevent errors
            ...
            <Dialog open={open} onClose={handleClickClose}>
                ...
                <div className="p-4">
                    <div className="mb-4 flex gap-2">
                        <label htmlFor="skillName" className="block w-full text-sm font-medium text-gray-600">Skill Name</label>
                        <input
                            type="text"
                            id="skillName"
                    ...
                    <div className="mb-4 flex gap-2">
                        <label htmlFor="skillCategory" className="block w-full text-sm font-medium text-gray-600">skill Category</label>
                        <input
                            type="text"
                            id="skillCategory"
                            className="mt-1 w-screen text-sm border outline-none border-gray-300 rounded-md shadow-sm block px-3 py-2 bg-white"
                    ...
                    <div className="mb-4 gap-2">
                        <label htmlFor="description" className="block w-full text-sm font-medium text-gray-600">skill Description</label>
                        <textarea
                            id="description"
