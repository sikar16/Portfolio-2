...
function AboutMe() {
    return (
        <div className="absolute top-[120%] mx-auto p-4 bg-[#efefef]">
            <div className="flex flex-col md:flex-row gap-8">
                ...
                <div className="lg:w-[80%] bg-white p-6 rounded-lg shadow-lg me-[3%]">
                    ...
                    <p className="text-gray-600 mb-6 ">
                        ...
                        that add value and deliver exceptional results. I am dedicated, energetic, and committed to exceeding client expectations.
                        lifecycle, utilizing technologies such as React, Node, Express, JavaScript, Bootstrap, jQuery, HTML5, CSS, MySQL, Visual Studio,
                        and Git. I have additional experience in Java, JavaFX, Flutter, Dart, C++, PHP, and Python. My goal is to develop customized applications
                        that add value and deliver exceptional results. I am dedicated, energetic, and committed to exceeding client expectations.
                    </p>
